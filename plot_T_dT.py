...
first_step    = 10000    # first step registered
step_interval = 10000    
...
Moist_adiabat = np.array([np.loadtxt(path + "pT_profiles/pT_Ts" + f'{j:02}' + "/p-T0000010000.dat",skiprows=1,usecols=2) for j in range(1,len(TsL)+1)])
